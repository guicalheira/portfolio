...
export default (props) => (
  <div className="aboutMe-flex">
   ...
   <span className="experiencia-text">
      Sou um programador focado em aplicativos da web e sites responsivos, apaixonado pelo mundo da
      programação . Minha jornada me levou a enfrentar
    ...
    <a className="curriculo" href={Curriculo}>Currículo</a>
